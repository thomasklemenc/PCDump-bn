...
_Binary Ninja plugin to dump Pseudo C and user-defined types into a folder._
...
Each dump also contains a `types.h` header generated from the analysis
database's user-defined types. Automatically imported platform and type-library
types are excluded. Every generated `.c` file includes `types.h`, allowing
decompiler output to reference user-defined structures, enumerations, unions,
and typedefs consistently.
